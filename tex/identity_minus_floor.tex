...
\draw [->][thin] (0, -3) -- (0, 3) node[above, blue] {$f(x)= x - \left\lfloor x \right\rfloor$};
...
{The periodic non-continuous $\mathrm {sawtooth()}$ returns the positive remainder $\{x\}$ in the range $[{0.0, 1.0})$.};
